...
server.on('error', function (error) {
    logger_1.default.error("Server error: ".concat(error.message));
});
...
function gracefulShutdown(signal) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1.default.info("Received ".concat(signal, ". Starting graceful shutdown..."));
                    return [4 /*yield*/, server.close()];
                case 1:
                    _a.sent();
                    logger_1.default.info('Server disconnected. Shutting down.');
                    process.exit(0);
                    return [2 /*return*/];
            }
        });
...
var _loop_1 = function (signal) {
    process.on(signal, function () {
        gracefulShutdown(signal).catch(function (error) {
            logger_1.default.error("Error during graceful shutdown: ".concat(error.message));
            process.exit(1);
        });
    });
};
